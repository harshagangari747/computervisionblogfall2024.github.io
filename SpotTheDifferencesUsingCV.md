...
<div align='center' height='50%'><img height=630px width='50%' src='https://github.com/user-attachments/assets/07879f06-d635-415a-a66f-1fa87ed3e571'/></div>
...
<h4>Analysis</h4>
We can see there are many clues generated by the model. The bottle in the center (green), dog behind, flowerpot behind the dog, brown flower pot in the bottom right in image2 are different evidently different in the image which the model detected. The model detected the dog as
